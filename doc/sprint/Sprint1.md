...
|:---:|:---:|:---:|:---:|:---:|:---:|
|T1i|Initialiser le projet avec Angular en utilisant la commande 'ng new', le projet s'appellera "projet-web-tbm". | N/A|N/A||Fait|
...
|T4.1i| Implémenter la tâche T4d, la tâche est fini lorsque les arrêts sont listés et le choix des arrêts possible sont récupérer en utilisant l'API de notre serveur.| 8 | T4d | Antonin | EN COURS |
